...
Use this reference only when `帮手` is considering helpers beyond Codex and Claude.
...
Prefer manager-owned helpers over full handoffs: Codex and Claude keep the final integration and review responsibility.
